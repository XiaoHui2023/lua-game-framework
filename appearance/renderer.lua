...
---@field dt? number 每次渲染推进的时间步�?---@field apply_change? fun(args:framework.appearance.apply_change.args):nil 应用表现变更回调
...
---@field reason string
---@field kind string
---@field modifier? framework.appearance.modifier 被重置的修正�?---@field replacement? framework.appearance.modifier 替换它的新修正器
---@field result? framework.appearance.result 当前渲染结果

---@param args? framework.appearance.renderer.options 表现渲染器配�?---@return framework.appearance.renderer
function M.renderer(args)
    ...
    o.factory.event_field("on_interrupt", { name = "interrupt" })
    o.factory.event_field("on_reset_kind", { name = "reset_kind" })
    o.factory.event_field("on_apply_change", { name = "apply_change" })
    o.factory.field("loop_scope").scope({ name = "loop" })

    ---@param kind string
    ---@param reason string
    ---@param modifier? framework.appearance.modifier 被重置的修正�?    ---@param replacement? framework.appearance.modifier 替换它的新修正器
    ...
    ---@param args? framework.appearance.modifier.options 表现修正器配�?    ---@return framework.appearance.modifier
    ...
    ---@param get_data? fun():table|framework.appearance.data|nil 每次循环获取渲染输入的函�?    ---@return fun()
