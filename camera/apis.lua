...
---@field LIMIT_IN_AREA lib.callback.api 字段说明
---@field SET_DISTANCE lib.callback.api 字段说明
---@field SET_YAW lib.callback.api 字段说明
---@field SET_PITCH lib.callback.api 字段说明
---@field SET_ROLL lib.callback.api 字段说明
---@field SET_POSITION lib.callback.api 字段说明
---@field SET_USER_CONTROL lib.callback.api 字段说明
local M = {}
