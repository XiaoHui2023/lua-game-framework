...
---@param phase string
---@param mode framework.damage.modifier_mode
---@return framework.damage.phase
return function(phase, mode)
    ---@class framework.damage.phase: lib.reactive.factory
    local o = reactive.factory({ name = phase })
    o.factory.set_class("framework.damage.phase")

    o.phase = phase
    o.mode = mode

    ---@type lib.reactive.add<framework.damage.modifier>
    ...
    ---@type lib.reactive.event<framework.damage.applied_modifier>
    ...
    ---@param state framework.damage.state
    ---@param initial any
    ---@return any
