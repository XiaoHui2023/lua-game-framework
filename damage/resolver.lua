...
---@param context? framework.damage.context 单次伤害结算上下�?---@return framework.damage.context
...
---@param self framework.damage
---@param context? framework.damage.context 单次伤害结算上下�?---@return framework.damage.result
