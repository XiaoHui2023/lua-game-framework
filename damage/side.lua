...
---@return framework.damage.source_side
function M.create_source()
    ---@class framework.damage.source_side
    local o = {}
...
---@return framework.damage.target_side
function M.create_target()
    ---@class framework.damage.target_side
    local o = {}
