...
---@field ON_KEY_DOWN_ASYNC lib.callback.api 本地异步按键按下时触发
---@field ON_KEY_UP_ASYNC lib.callback.api 本地异步按键抬起时触发
...
---@field ON_KEY_DOWN_SYNC lib.callback.api 同步后的按键按下事件
---@field ON_KEY_UP_SYNC lib.callback.api 同步后的按键抬起事件
