...
M.ON_PLAYER_LEAVE = hook.event()
---@type hook.event 游戏初始化事件
M.ON_GAME_INIT = hook.event()
---@type hook.event 单位受到伤害事件（受伤者:unit.handle, 攻击者:unit.handle）
M.ON_UNIT_DAMAGE_TAKEN = hook.event()
---@type hook.event 单位造成伤害事件（攻击者:unit.handle, 受伤者:unit.handle）
M.ON_UNTI_DAMAGE_DEALT = hook.event()
---@type hook.event<event.input>
M.ON_KEY_DOWN_ASYNC = hook.event()
---@type hook.event<event.input>
M.ON_KEY_UP_ASYNC = hook.event()
---@type hook.event<event.input> 鼠标移动异步事件
M.ON_MOUSE_MOVE_ASYNC = hook.event()
---@type hook.event<event.input> 鼠标按下异步事件
M.ON_MOUSE_DOWN_ASYNC = hook.event()
---@type hook.event<event.input> 鼠标抬起异步事件
M.ON_MOUSE_UP_ASYNC = hook.event()
---@type hook.event 鼠标向上滚轮事件
M.ON_WHEEL_UP = hook.event()
---@type hook.event 鼠标向下滚轮事件
M.ON_WHEEL_DOWN = hook.event()
---@type hook.event 选择单位事件<player, unit>
M.ON_SELECT_UNIT = hook.event()
---@type hook.event 帧更新事件
M.ON_UPDATE = hook.event()
---@type hook.once_event 帧更新删除
M.ONCE_UPDATE = hook.once_event()
---@type hook.event<event.input.sync>
M.ON_KEY_DOWN_SYNC = hook.event()
---@type hook.event<event.input.sync>
M.ON_KEY_UP_SYNC = hook.event()
---@type hook.event<event.input.sync> 鼠标移动同步事件
M.ON_MOUSE_MOVE_SYNC = hook.event()
---@type hook.event<event.input.sync> 鼠标按下同步事件
M.ON_MOUSE_DOWN_SYNC = hook.event()
---@type hook.event<event.input.sync> 鼠标抬起同步事件
M.ON_MOUSE_UP_SYNC = hook.event()
