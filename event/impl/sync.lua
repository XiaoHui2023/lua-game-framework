...
-- 异步发送鼠标移动
g.ON_MOUSE_MOVE_ASYNC(function(api)
    SYNC_MOUSE_MOVE(api.input)
end)
-- 异步发送按键按下
g.ON_KEY_DOWN_ASYNC(function(api)
    SYNC_KEY_DOWN(api.input)
end)
-- 异步发送按键抬起
g.ON_KEY_UP_ASYNC(function(api)
    SYNC_KEY_UP(api.input)
end)
-- 异步发送鼠标按下
g.ON_MOUSE_DOWN_ASYNC(function(api)
    SYNC_MOUSE_DOWN(api.input)
end)
-- 异步发送鼠标抬起
g.ON_MOUSE_UP_ASYNC(function(api)
