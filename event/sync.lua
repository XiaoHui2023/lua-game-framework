...
-- 异步发送鼠标移动
M.ON_MOUSE_MOVE_ASYNC.add(function(input)
    SYNC_MOUSE_MOVE(input)
end)
M.ON_KEY_DOWN_ASYNC.add(function(input)
    SYNC_KEY_DOWN(input)
end)
M.ON_KEY_UP_ASYNC.add(function(input)
    SYNC_KEY_UP(input)
end)
-- 异步发送鼠标按下
M.ON_MOUSE_DOWN_ASYNC.add(function(input)
    SYNC_MOUSE_DOWN(input)
end)
-- 异步发送鼠标抬起
M.ON_MOUSE_UP_ASYNC.add(function(input)
    SYNC_MOUSE_UP(input)
end)
