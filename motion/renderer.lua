...
---@type table<framework.motion.modifier.phase, integer>
local PHASE_ORDER = {
    normal = 1,
    post = 2,
}
...
---@param a framework.motion.modifier
---@param b framework.motion.modifier
---@return boolean
...
function M.renderer(args)
    ...
    ---@class framework.motion.renderer : lib.reactive.factory
    local o = reactive.factory(args)
    o.set_class("framework.motion.renderer")
    ...
    o.on_active_interrupt = o.factory.event({ name = "active_interrupt" })
    o.on_passive_interrupt = o.factory.event({ name = "passive_interrupt" })
    o.on_interrupt = o.on_passive_interrupt
    o.on_reset_height = o.factory.event({ name = "reset_height" })
