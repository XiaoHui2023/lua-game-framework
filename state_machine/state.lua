...
---@alias framework.state_machine.state_status
---| "idle"
---| "running"
---| "done"
---| "interrupted"
...
---@field domain framework.state_machine.machine 兼容旧 state.domain，等同于 machine
...
---@param child framework.state_machine.state
