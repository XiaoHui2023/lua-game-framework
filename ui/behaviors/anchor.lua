...
return function (o,args)
    args.anchor = args.anchor or g.anchor()
    
    ---@class ui
    o = o

    ---@type hook.set 锚定点<ui.anchor>
    o.anchor = o.factory.set(args.anchor)

    -- 锚定某个位置
    ---@param relative_ui ui 目标UI
    ---@param anchor ui.anchor 锚点
    ---@param point ui.position 锚定点
    ---@param relative_point ui.position 相对锚定点
    ...
    ---@param opts ui.anchor_position.options? 锚点
    ...
    ---@type hook.computed 渲染位置<ui.position>
