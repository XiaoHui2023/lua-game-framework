...
---@class framework.ui.components.status.heart_health
local M = {}
...
---@class framework.ui.components.status.heart_health.progress_options: framework.ui.slot.progress.options
---@field image? any
---@field size? framework.ui.size_spec
---@field rotation? number
---@field color? lib.color|table

---@class framework.ui.components.status.heart_health.image_options: framework.ui.slot.image.options
---@field image? any
---@field size? framework.ui.size_spec

---@class framework.ui.components.status.heart_health.options: framework.ui.slot.options
---@field name? string
---@field size? framework.ui.size_spec
---@field progress? framework.ui.components.status.heart_health.progress_options
---@field image? framework.ui.components.status.heart_health.image_options

---@class framework.ui.widget.heart_health: framework.ui.slot
---@field progress framework.ui.slot.progress 心形血量进度环
---@field image framework.ui.slot.image 心形血量图标

---@param args framework.ui.components.status.heart_health.options?
---@param ... framework.ui.components.status.heart_health.options?
---@return framework.ui.widget.heart_health
M.create = function(args, ...)
    args = table.merge(args or {}, ...)
    args.name = args.name or "heart_health"
