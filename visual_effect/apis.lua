...
---@field SET_DURATION lib.callback.api 设置指定特效的持续时间
...
---@field handle? visual_effect.handle 运行时写回的特效句柄
...
---@field x? number X 轴旋转角度
---@field y? number Y 轴旋转角度
---@field z? number Z 轴旋转角度
---@type lib.callback.api
...
---@field scale_x? number X 轴缩放倍率
---@field scale_y? number Y 轴缩放倍率
---@field scale_z? number Z 轴缩放倍率
---@type lib.callback.api
...
---@field color? lib.color|table 特效颜色
...
---@field duration number 持续时间，单位秒
---@type lib.callback.api
